...
const postFolderHandler = (req, res, next) => {
  const { name } = req.body;
  const userId = req.user.id;
...
const putFolderHandler = (req, res, next) => {
  const { id } = req.params;
  const { name } = req.body;
  const userId = req.user.id;
...
module.exports = { getAllFoldersHandler, getFolderByIdHandler, postFolderHandler, putFolderHandler, deleteFolderHandler}
